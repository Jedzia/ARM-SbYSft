...
set PATH=C:\Toolchain\ARM\gcc-arm-none-eabi-4_8-140708\bin;C:\Toolchain\mingw-w64\x86_64-w64-mingw32-8.3.0-crt-6.0.0-multilib\bin;C:\msys64\usr\bin;C:\Toolchain\OpenOCD\OpenOCD-20190210-0.10.0\bin;%PATH%
...
echo .
echo .
echo make clean && make && ..\BootCommander -s=xcp -t=xcp_usb build\STM32CubeMX.srec
echo make clean
echo .
echo .
cmd